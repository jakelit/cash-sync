...
class TestAllyImporterUnit:
    ...
    def test_parse_transaction_amount_positive(self):
        ...
        ally = AllyImporter()
        assert ally._parse_transaction_amount("123.45") == 123.45
    ...
    def test_parse_transaction_amount_negative(self):
        ...
        from cash_sync.ally_importer import AllyImporter
        ally = AllyImporter()
        assert ally._parse_transaction_amount("-67.89") == -67.89
    ...
    def test_parse_transaction_amount_invalid(self):
        ...
        from cash_sync.ally_importer import AllyImporter
        ally = AllyImporter()
        assert ally._parse_transaction_amount("notanumber") == 0.0   
    ...
    def test_get_expected_columns(self):
        ...
        assert ally._get_expected_columns() == expected
    ...
    def test_get_institution_name(self):
        ...
        from cash_sync.ally_importer import AllyImporter
        ally = AllyImporter()
        assert ally._get_institution_name() == "Ally Bank"
    ...
    def test_get_account_name(self):
        ...
        from cash_sync.ally_importer import AllyImporter
        ally = AllyImporter()
        assert ally._get_account_name() == "Ally"
